...
class PorterStemmer:
    ...
    def isVowel(self, word, i):
        if(self.isConsonant(word, i)):
            ...
            return True
        # return not(self.isConsonant(self,word, i))
    ...
    def stem(self, word):
        ...
        for i in range(len(word_list)):
            word_list[i] = self.step1a(word_list[i])
            word_list[i] = self.step1b(word_list[i])
            word_list[i] = self.step1c(word_list[i])
            word_list[i] = self.step2(word_list[i])
            word_list[i] = self.step3(word_list[i])
            word_list[i] = self.step4(word_list[i])
            word_list[i] = self.step5a(word_list[i])
            word_list[i] = self.step5b(word_list[i])
        word = ' '.join(word_list)
        return word
